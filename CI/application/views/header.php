										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<ul class="nav navbar-nav navbar-right">
													...
													<!-- mega-menu start -->
													<li class="">
														<a href="<?=base_url("")?>" class="" data-toggle="">Home</a>
													</li>

													<!-- mega-menu end -->
													<!-- mega-menu start -->
													<li class="">
														<a href="<?=base_url("product_list")?>" class="" data-toggle="">Product List</a>
													</li>

													<li class="">
														<a href="#" class="" data-toggle="">Login</a>
													</li>
												<!-- main-menu end -->
															...
															<li>
																<table class="table table-hover">
																	...
																	<tbody>
																		...
																		<tr>
																			<td class="quantity"> X <?=$v['qty']?></td>
																			<td class="product"><?=$v['product_title']?></td>
																			<td class="amount">$<?=$v['product_price'] * $v['qty'] ?></td>
																		</tr>

																		<?php

																			$totalAmount += $v['product_price'] * $v['qty']; 
																			}
																		}
																		?>

																		<tr>
																			<td class="total-quantity" colspan="2">Total: <?=$cartTotal?> type of item</td>
